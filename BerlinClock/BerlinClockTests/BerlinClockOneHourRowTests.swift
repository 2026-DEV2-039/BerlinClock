...
struct BerlinClockOneHourRowTests {
    ...
    func oneHourRow_turnsOnOneLamp_forOneHour() {
        let calculator = BerlinClockRowCalculator()
        let result = calculator.convertDigitalTimeToBerlinClock(DigitalTime(hours: 1, minutes: 0, seconds: 0))
    ...
    func oneHourRow_turnsOnTwoLamps_forTwoHours() {
        let calculator = BerlinClockRowCalculator()
        let result = calculator.convertDigitalTimeToBerlinClock(DigitalTime(hours: 2, minutes: 0, seconds: 0))
    ...
    func oneHourRow_turnsOnThreeLamps_forThreeHours() {
        let calculator = BerlinClockRowCalculator()
        let result = calculator.convertDigitalTimeToBerlinClock(DigitalTime(hours: 3, minutes: 0, seconds: 0))
